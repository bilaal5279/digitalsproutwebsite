                ...
                <div className="bg-white rounded-xl shadow-lg p-8 md:p-12">
                    ...
                    <section className="mb-8">
                        ...
                        <p className="text-gray-600 leading-relaxed">
                            By downloading, installing, or using Who Touched My Phone? ("the App"), you
                    ...
                    <section className="mb-8">
                        ...
                        <p className="text-gray-600 leading-relaxed mb-4">
                            Who Touched My Phone? is a phone security application that allows users to:
                        </p>
                        <ul className="space-y-2 text-gray-600">
                            <li className="flex items-start">
                                <span className="text-emerald-600 mr-2">•</span>
                                Detect when someone touches or moves your phone
                            </li>
                            <li className="flex items-start">
                                <span className="text-emerald-600 mr-2">•</span>
                                Sound an alarm to alert you of unauthorized access
                            </li>
                            <li className="flex items-start">
                                <span className="text-emerald-600 mr-2">•</span>
                                Protect your device from snooping
                            </li>
                        </ul>
                    </section>
                    ...
                    <section className="mb-8">
                        ...
                        <p className="text-gray-600 leading-relaxed mb-4">
                            By using Who Touched My Phone?, you agree to:
                        </p>
                        <ul className="space-y-2 text-gray-600 mb-4">
                            <li className="flex items-start">
                                <span className="text-emerald-600 mr-2">•</span>
                                Use the app responsibly and only on your own devices
                            </li>
                            <li className="flex items-start">
                                <span className="text-emerald-600 mr-2">•</span>
                                Respect the privacy of others when using the app
                            </li>
                            <li className="flex items-start">
                                <span className="text-emerald-600 mr-2">•</span>
                        ...
                        <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mt-4">
                            ...
                            <p className="text-amber-700">
                                All app settings are stored locally on your device. If you uninstall the app, your preferences will be removed.
                            </p>
                        </div>
                    </section>
                    ...
                    <section className="mb-8">
                        ...
                        <p className="text-gray-600 leading-relaxed mb-4">
                            You may not use Who Touched My Phone? to:
                        </p>
                        <ul className="space-y-2 text-gray-600">
                            <li className="flex items-start">
                                <span className="text-red-500 mr-2">✗</span>
                                Monitor devices that do not belong to you without consent
                            </li>
                            <li className="flex items-start">
                                <span className="text-red-500 mr-2">✗</span>
                    ...
                    <section className="mb-8">
                        ...
                        <p className="text-gray-600 leading-relaxed mb-4">
                            Who Touched My Phone? is designed with privacy as a core principle:
                        </p>
                        <ul className="space-y-2 text-gray-600 mb-4">
                            <li className="flex items-start">
                        ...
                        <div className="space-y-4">
                            <div className="border border-gray-200 rounded-lg p-4">
                                ...
                                <p className="text-gray-600 text-sm">
                                    Who Touched My Phone? is a security alert tool only. It is designed to detect device movement and sound an alarm. We make no guarantees about preventing unauthorized access to your device.
                                </p>
                            </div>
                        </div>
                    </section>
                    ...
                    <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-6 mt-8">
                        ...
                        <p className="text-emerald-700 font-medium">
                            Who Touched My Phone? helps protect your device with zero data collection.
                            All settings and preferences stay 100% on your device.
                        </p>
                    </div>
                </div>
            </div>
...
export default WtmpTermsOfService;
