...
import { Shield, ArrowLeft, Heart, Database, Lock, Eye, Volume2 } from 'lucide-react';

const SpeakerPrivacyPolicy = () => {
    return (
                ...
                <div className="bg-white rounded-xl shadow-lg p-8 md:p-12">
                    ...
                    <section className="mb-8">
                        ...
                        <p className="text-gray-600 leading-relaxed">
                            SPEAKER CLEANER - REMOVE WATER is a utility application designed with your privacy as the absolute priority.
                    ...
                    <section className="mb-8">
                        ...
                        <div className="bg-green-50 border border-green-200 rounded-lg p-6 mb-4">
                            ...
                            <p className="text-green-700">
                                SPEAKER CLEANER - REMOVE WATER does not collect, store, or transmit any personal information, usage data, or logs
                                to external servers or third parties. The app functions entirely offline for its core utility.
                            </p>
                        </div>
                        ...
                        <ul className="space-y-2 text-gray-600">
                            ...
                            <li className="flex items-start">
                                <span className="text-blue-600 mr-2">•</span>
                                Microphone recordings (if microphone access is ever requested, it is processed in real-time only)
                            </li>
                            <li className="flex items-start">
                                <span className="text-blue-600 mr-2">•</span>
                    ...
                    <section className="mb-8">
                        <div className="flex items-center mb-4">
                            <Lock size={24} className="text-blue-600 mr-3" />
                            <h2 className="text-2xl font-bold text-gray-900">Data Storage</h2>
                        </div>
                        <p className="text-gray-600 leading-relaxed mb-4">
                            We do not persist any user data. Any settings changed (like volume or frequency) may be stored locally on your device using standard user preferences, but this data never leaves your device.
                        </p>
                        <ul className="space-y-2 text-gray-600 mb-4">
                            <li className="flex items-start">
                                <span className="text-blue-600 mr-2">•</span>
                                Preferences stored directly in your device's standard storage
                            </li>
                            <li className="flex items-start">
                                <span className="text-blue-600 mr-2">•</span>
                            ...
                            <li className="flex items-start">
                                <span className="text-blue-600 mr-2">•</span>
                                Deleting the app removes all associated preferences
                            </li>
                        </ul>
                    </section>
                    ...
                    <section className="mb-8">
                        ...
                        <p className="text-gray-600 leading-relaxed">
                            SPEAKER CLEANER - REMOVE WATER does not integrate with any third-party services, analytics platforms, advertising networks,
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mt-8">
                        ...
                        <p className="text-blue-700 font-medium">
                            SPEAKER CLEANER - REMOVE WATER is designed with privacy by default. We collect no data, store nothing externally,
                            and all operations happen locally on your device. Your privacy is completely protected.
                        </p>
                    </div>
                </div>
            </div>
...
export default SpeakerPrivacyPolicy;
