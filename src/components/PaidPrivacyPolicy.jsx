                ...
                <div className="bg-white rounded-xl shadow-lg p-8 md:p-12">
                    ...
                    <section className="mb-8">
                        ...
                        <p className="text-gray-600 leading-relaxed">
                            Paid is an invoicing application that helps you create and manage professional invoices.
                    ...
                    <section className="mb-8">
                        ...
                        <div className="bg-green-50 border border-green-200 rounded-lg p-6 mb-4">
                            ...
                            <p className="text-green-700">
                                Paid does not collect, store, or transmit any personal information, invoice data, client lists, or financial information
                        ...
                        <ul className="space-y-2 text-gray-600">
                            <li className="flex items-start">
                                ...
                                Your invoice details (amounts, items, client instructions)
                            </li>
                            <li className="flex items-start">
                                <span className="text-teal-600 mr-2">•</span>
                                Client information (names, addresses, emails)
                            </li>
                            <li className="flex items-start">
                                <span className="text-teal-600 mr-2">•</span>
                                Your business details or logo
                            </li>
                            <li className="flex items-start">
                                <span className="text-teal-600 mr-2">•</span>
                    ...
                    <section className="mb-8">
                        ...
                        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mt-2">
                            <div className="flex items-center mb-2">
                                ...
                                <h3 className="text-lg font-semibold text-blue-800">PDF Generation</h3>
                            </div>
                            <p className="text-blue-700 text-sm">
                                When you generate a PDF invoice, the file is created locally on your device. We do not see, store, or have access to these files. You choose how to share them (email, messaging, etc.) using your device's standard sharing capabilities.
                            </p>
                        </div>
                    </section>
                    ...
                    <section className="mb-8">
                        ...
                        <p className="text-gray-600 leading-relaxed mb-4">
                            Paid may request the following permissions:
                        </p>
                        <div className="space-y-4">
                            <div className="border border-gray-200 rounded-lg p-4">
                                <h3 className="font-semibold text-gray-900 mb-2">Storage / File Access</h3>
                                <p className="text-gray-600 text-sm">
                                    Required to save and export your generated PDF invoices to your device.
                                </p>
                            </div>
                        </div>
                    </section>
                    ...
                    <section className="mb-8">
                        ...
                        <p className="text-gray-600 leading-relaxed">
                            Paid does not integrate with any third-party analytics platforms, advertising networks,
                            or external APIs.
                        </p>
                    </section>
                    ...
                    <section className="mb-8">
                        ...
                        <p className="text-gray-600 leading-relaxed">
                            ...
                            However, you are responsible for securing access to your physical device.
                        </p>
                    </section>
                    ...
                    <div className="bg-teal-50 border border-teal-200 rounded-lg p-6 mt-8">
                        ...
                        <p className="text-teal-700 font-medium">
                            Paid is 100% offline-first tailored. We don't spy on your business. Your invoices, clients, and data stay on your phone.
                        </p>
                    </div>
                </div>
            </div>
...
export default PaidPrivacyPolicy;
