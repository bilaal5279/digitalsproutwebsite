...
import { Shield, ArrowLeft, Smartphone, Database, Lock, Eye } from 'lucide-react';
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 md:p-12">
          ...
          <section className="mb-8">
            <div className="flex items-center mb-4">
              <Smartphone size={24} className="text-teal-600 mr-3" />
              <h2 className="text-2xl font-bold text-gray-900">Introduction</h2>
            </div>
            <p className="text-gray-600 leading-relaxed">
              FindMyDevice is a Bluetooth device scanner application that helps you locate and identify nearby Bluetooth devices. 
              We are committed to protecting your privacy and being transparent about our data practices. This privacy policy 
          ...
          <section className="mb-8">
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-6 mb-4">
              ...
              <p className="text-green-700">
                FindMyDevice does not collect, store, or transmit any personal information, user data, or device information 
            ...
            <ul className="space-y-2 text-gray-600">
              ...
              <li className="flex items-start">
                <span className="text-teal-600 mr-2">•</span>
                Bluetooth scan results or device lists
              </li>
              <li className="flex items-start">
                <span className="text-teal-600 mr-2">•</span>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              All app functionality operates entirely on your device. Any temporary data used for the app's operation 
              (such as Bluetooth scan results) is:
            </p>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              FindMyDevice requires the following permissions to function:
            </p>
            <div className="space-y-4">
              <div className="border border-gray-200 rounded-lg p-4">
                <h3 className="font-semibold text-gray-900 mb-2">Bluetooth Access</h3>
                <p className="text-gray-600 text-sm">
                  Required to scan for and identify nearby Bluetooth devices. This permission is used solely for 
                  the app's core functionality and no data is stored or transmitted.
                </p>
              </div>
              <div className="border border-gray-200 rounded-lg p-4">
                <h3 className="font-semibold text-gray-900 mb-2">Location Permission (Android)</h3>
                <p className="text-gray-600 text-sm">
                  Required by Android for Bluetooth scanning functionality. We do not access, store, or use 
                  your location data in any way.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 leading-relaxed">
              FindMyDevice does not integrate with any third-party services, analytics platforms, advertising networks, 
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 leading-relaxed">
              Since we don't collect or store any personal data, there are no data security risks associated with 
              external data breaches. All app operations are contained within your device's secure environment.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              an updated effective date. Since we don't collect user data, we cannot notify users directly of changes.
            </p>
          </section>
          ...
          <div className="bg-teal-50 border border-teal-200 rounded-lg p-6 mt-8">
            ...
            <p className="text-teal-700 font-medium">
              FindMyDevice is designed with privacy by default. We collect no data, store nothing externally, 
              and everything happens locally on your device. Your privacy is completely protected.
            </p>
          </div>
        </div>
      </div>
