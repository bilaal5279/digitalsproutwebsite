...
import { Shield, ArrowLeft, Bug, Database, Lock, Eye, CloudLightning } from 'lucide-react';

const ArachnidPrivacyPolicy = () => {
    return (
                ...
                <div className="bg-white rounded-xl shadow-lg p-8 md:p-12">
                    ...
                    <section className="mb-8">
                        <div className="flex items-center mb-4">
                            <Bug size={24} className="text-slate-800 mr-3" />
                            <h2 className="text-2xl font-bold text-gray-900">Introduction</h2>
                        </div>
                        <p className="text-gray-600 leading-relaxed">
                            ARACHNID: SPIDER IDENTIFIER ("Arachnid") is a utility app powered by artificial intelligence to help users identify spiders and arachnids.
                    ...
                    <section className="mb-8">
                        ...
                        <ul className="space-y-2 text-gray-600">
                            <li className="flex items-start">
                                ...
                                <strong>Images:</strong> Photos of spiders you upload or capture are transmitted to Google Gemini for analysis.
                            </li>
                            <li className="flex items-start">
                                <span className="text-amber-600 mr-2">•</span>
                    ...
                    <div className="bg-slate-50 border border-slate-200 rounded-lg p-6 mt-8">
                        ...
                        <p className="text-slate-700 font-medium">
                            ARACHNID uses Google Gemini AI to identify spiders. Your images are sent to the AI for analysis but are not permanently stored by Digitalsprout.
...
export default ArachnidPrivacyPolicy;
