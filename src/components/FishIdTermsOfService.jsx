                ...
                <div className="bg-white rounded-xl shadow-lg p-8 md:p-12">
                    ...
                    <div className="bg-red-50 border border-red-200 rounded-lg p-6 mb-8 border-l-4 border-l-red-600">
                        ...
                        <p className="text-red-700 font-bold mb-2 uppercase">
                            DO NOT TOUCH OR HANDLE FISH BASED ON THIS APP.
                        </p>
                        <p className="text-red-700 text-sm leading-relaxed mb-3">
                            Artificial Intelligence is NOT infallible. The identification provided by FishID is a <strong>prediction based on probabilities</strong> and can be incorrect. Harmless fish often look similar to poisonous or dangerous ones.
                        </p>
                        <p className="text-red-700 text-sm leading-relaxed">
                            <strong>ALWAYS assume a fish is dangerous unless confirmed by a professional expert.</strong> We are strictly not liable for any bites, stings, allergic reactions, injuries, or damages resulting from your interaction with any creature.
                        </p>
                    </div>
                    ...
                    <div className="bg-amber-50 border border-amber-200 rounded-lg p-6 mb-8">
                        ...
                        <p className="text-amber-700 text-sm leading-relaxed mt-2">
                            <strong>IF YOU ARE INJURED:</strong> Do not rely on this app for a diagnosis. Seek immediate professional medical attention.
                        </p>
                    </div>
                    ...
                    <section className="mb-8">
                        ...
                        <p className="text-gray-600 leading-relaxed">
                            By downloading or using FISHID ("the App"), you agree to be bound by these Terms.
                    ...
                    <section className="mb-8">
                        ...
                        <p className="text-gray-600 leading-relaxed mb-4">
                            We use advanced AI (Google Gemini) to identify fish, but <strong>no AI is 100% accurate</strong>. Identifications may be wrong due to poor lighting, blur, unique angles, or similar-looking species.
                        </p>
                    ...
                    <div className="bg-slate-50 border border-slate-200 rounded-lg p-6 mt-8">
                        ...
                        <p className="text-slate-700 font-medium">
                            FishID is an informational tool. It is not a safety device or a doctor. <strong>You use it at your own risk.</strong>
                            We are not responsible if you get injured. Stay safe and always consult professional experts.
                        </p>
                    </div>
                </div>
            </div>
...
export default FishIdTermsOfService;
